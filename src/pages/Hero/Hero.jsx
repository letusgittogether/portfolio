...
export default function Hero() {
  const words = [
    "Full-Stack Decentralized Software Developer",
...
const profile = {
    ...
    Skills: [
      'Solidity', 'Truffle', 'Hardhat', 'Web3.js', 'Ethers.js', 'IPFS',
      'Rust', 'Anchor', 'Go', 'JavaScript', 'Solana Web3.js', 'Metaplex JS',
      'zk-SNARKs', 'zk-STARKs', 'Circom', 'Noir', 'SnarkJS', 'zkShuffle',
      'React', 'Vue', 'Next.js', 'TypeScript', 'Redux Toolkit', 'Zustand',
      'Chakra UI', 'Tailwind CSS', 'Material UI', 'Webpack', 'Storybook',
      'Node.js', 'Express.js', 'Nest.js', 'REST APIs', 'GraphQL', 'Firebase',
      'PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'SQLite', 'ElasticSearch',
      'AWS', 'Docker', 'Kubernetes', 'Terraform', 'GitHub Actions', 'Anvil',
      'Slither', 'Chai', 'Mocha', 'Jest', 'Cypress', 'Playwright',
      'CI/CD', 'Agile', 'Scrum', 'Kanban', 'JIRA', 'Trello'
    ],
    Experiences: [
      'Ethereum', 'Solana', 'Zero-Knowledge Poofs', 
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Solidity, JavaScript lover 🚀 | ZKPs  🔧 | Crafting frameworks
